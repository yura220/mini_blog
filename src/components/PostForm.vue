<template>
  <div class="neu-card">
    ...
    <form @submit.prevent="handleSubmit">
      ...
      <textarea v-model="content" class="neu-textarea" placeholder="내용" required></textarea>
...
function handleSubmit() {
  if (isEdit) {
    store.updatePost(Number(route.params.id), { title: title.value, content: content.value });
  } else {
